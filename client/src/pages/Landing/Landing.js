...
export default function Landing() {
  ...
  return (
    <div className="landing">
      ...
      <img className="hot-dog-img-one" src={hotdogSVG} alt="Hot Dog" />
      <img className="hot-dog-img-two" src={hotdogSVG} alt="Hot Dog" />
      <img className="hot-dog-img-three" src={hotdogSVG} alt="Hot Dog" />
      <img className="hot-dog-img-four" src={hotdogSVG} alt="Hot Dog" />
      <img className="hot-dog-img-five" src={hotdogSVG} alt="Hot Dog" />
      <img className="hot-dog-img-six" src={hotdogSVG} alt="Hot Dog" />
